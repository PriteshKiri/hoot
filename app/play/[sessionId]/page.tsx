...
export default function PlayPage() {
  ...
  useEffect(() => {
    const token = sessionStorage.getItem("hoot_participant_token")
    ...
    const storedName = sessionStorage.getItem("hoot_display_name")
    const storedAvatar = sessionStorage.getItem("hoot_avatar")
    const storedParticipantId = sessionStorage.getItem("hoot_participant_id")
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        <div className="text-center space-y-4">
          ...
          <a href="/join" className="inline-block rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground hover:bg-primary/90 transition">Back to Join</a>
        </div>
      </div>
    )
  }
...
function QuestionView({
  question, questionStartedAt, sessionId, participantToken,
...
function EndView({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-background px-4 space-y-8">
      ...
      <a href="/join" className="rounded-xl bg-primary px-6 py-3 text-sm font-bold text-primary-foreground hover:bg-primary/90 transition">
        Play Again
      </a>
    </div>
  )
